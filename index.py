...
#Level Text 
level_3_text = pygame.transform.scale(pygame.image.load("images/lvl_3_txt.png"), (290, 190)).convert_alpha()
level_2_text = pygame.transform.scale(pygame.image.load("images/lvl_2_txt.png"), (290, 190)).convert_alpha()
